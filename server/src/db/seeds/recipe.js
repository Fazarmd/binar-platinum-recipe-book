...
export const seed = async function (knex) {
  ...
  const user2 = await knex("users").where("username", "user2").first();
  await knex("recipe").insert([
    {
      id: uuidv4(),
      user_id: user1.id,
      title: "Fried Rice",
      ingredients: "White rice, Garlic, Chicken, Sweet soy sauce or soy sauce, Sambal, Scallions, Salt",
      instruction:
      ...
      caption: "Enjoy savory and delicious home-style fried rice with this recipe, made with simple ingredients such as rice, chicken, eggs and vegetables.",
    ...
    },
    {
      ...
      user_id: user1.id,
      title: "Rendang Meat",
      ingredients: "Beef (500-700g), Coconut milk (1 can), Lemongrass, Ginger, Tamarind paste, Brown sugar, Salt, Oil.",
      instruction:
    ...
    },
    {
      ...
      user_id: user2.id,
      title: "Salad Caesar",
      ingredients: "Romaine leaves, Croutons, Parmesan cheese, Caesar dressing, Grilled chicken",
      instruction: "1. Cut romaine leaves and grilled chicken into small pieces. \n2. Add croutons and parmesan cheese. \n3. Drizzle with Caesar dressing. \n4. Mix well and serve.",
    ...
    },
    {
      ...
      user_id: user2.id,
      title: "Pancake",
      ingredients: "Wheat flour, eggs, milk, sugar, baking powder, vegetable oil",
      instruction:
